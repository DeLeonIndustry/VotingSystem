<x-layouts.app>
    <div class="relative isolate px-6 pt-4 lg:px-8">
        ...
        <div class="mt-32 sm:mx-auto sm:w-full sm:max-w-md">
            <h2 class="mt-24 text-3xl font-extrabold text-center text-gray-900 leading-49">
                Account Registration<span>
            </h2>
            <p class="mt-2 mb-2 text-center">Already have an account? <span><a class="font-medium text-indigo-600 hover:text-indigo-500 focus:outline-none focus:underline transition ease-in-out duration-150" href="/login">Sign-in.</a></span></p>
