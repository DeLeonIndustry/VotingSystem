...
<body>
    <header class="absolute inset-x-0 top-0 z-50">
        ...
        <!-- Mobile menu, show/hide based on JavaScript state -->
        <div id="mobileMenu"
            class="lg:hidden fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10"
            style="display: none;">
            <div class="flex items-center justify-between">
                <a href="#" class="-m-1.5 p-1.5">
                    <span class="sr-only">Vothings</span>
                    <img class="h-8 w-auto" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600"
                        alt="">
                </a>
                <!-- Close menu button -->
    ...
    {{ $slot }}
    <script src="{{ url('/assets/navigationBar.js') }}"></script>
